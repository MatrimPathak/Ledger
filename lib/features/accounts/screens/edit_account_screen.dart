...
class _EditAccountScreenState extends ConsumerState<EditAccountScreen> {
  ...
  void initState() {
    ...
    _digitsCtrl = TextEditingController(text: a.lastSixDigits);
    _holderCtrl = TextEditingController(text: a.holderName);
    _balanceCtrl = TextEditingController(text: a.balance.toStringAsFixed(2));
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      await ref.read(firestoreServiceProvider).updateAccount(updated);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('•• $lastSix',
              style: const TextStyle(
                  color: Colors.white60, fontSize: 13, letterSpacing: 4)),
